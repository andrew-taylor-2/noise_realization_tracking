function kODF_nii_preprocess(FT_parameters,dki_dt,dki_kt,dki_fa,studydir2,seedmask2)
...
input_struc.studydir=studydir2;
if exist('seedmask2','var')
    input_struc.seed_mask=seedmask2;
end
...
%         KT=load(dki_kt); %andrew 
%         DT=load(dki_dt); %andrew
%         DT=DT.DT;
%         KT=KT.KT;
